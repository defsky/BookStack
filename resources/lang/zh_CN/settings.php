...
return [
    ...
    'app_public_access' => '公众访问',
    'app_public_access_desc' => '打开这个特性，将会允许未登录的用户查看你书架中的内容。',
    'app_public_access_desc_guest' => '公众用户的访问权限可以通过“游客”账户来控制',
    ...
    'reg_allow' => '允许注册？',
    'reg_enable' => '开启注册',
    'reg_enable_toggle' => '开启注册',
    'reg_enable_desc' => '开启注册后用户可以通过注册页面注册账号，并被分配一个默认的用户角色',
    'reg_default_role' => '注册后的默认用户角色',
    'reg_confirm_email' => '需要Email验证？',
    'reg_email_confirmation' => '邮箱验证',
    'reg_email_confirmation_toggle' => '要求邮箱验证',
    ...
    'users_add_new' => '添加用户',
    'users_details' => '用户详情',
    'users_details_desc' => '为用户设置一个显示名称和邮箱地址，这个邮箱地址会被作为登录账号。',
    'users_details_desc_no_email' => '为用户设置一个显示名称。',
    'users_search' => '搜索用户',
    'users_role' => '用户角色',
    'users_role_desc' => '勾选用户需要被赋予的角色。如果用户被赋予了多个角色，那么这些角色的权限会叠加，用户会取得所有这些角色的权限。',
    'users_external_auth_id' => '外部身份认证ID',
    'users_external_auth_id_desc' => '这个ID将用来在你的LDAP系统中唯一标识这个用户。',
    'users_password' => '用户密码',
    'users_password_desc' => '为用户设置一个登录密码，至少5个字符长度。',
    ...
    'users_preferred_language' => '首选语言',
    'users_preferred_language_desc' => '这个选项将会改变用户界面默认显示的语言。这不会影响到用户创建的内容。',
